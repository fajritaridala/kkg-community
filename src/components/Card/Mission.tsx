...
export default function MissionCard(props: PropTypes) {
  ...
  return (
    ...
    >
      ...
      <p className="absolute bottom-0 left-0 z-10 h-full translate-y-full bg-primary px-2 py-4 text-center text-xs leading-relaxed font-semibold text-foreground-light transition-transform duration-500 ease-in-out group-hover:translate-y-0 group-focus:translate-y-0 md:p-4 md:text-sm">
        {description}
      </p>
    </div>
  )
